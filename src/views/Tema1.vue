  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .fullview-blue.px-4.px-md-2
      .row.mb-5(data-aos="fade")
        .col-md-10.col-lg-8.mx-auto.p-5
          ...
          figure
            img(src='@/assets/curso/temas/tema1/img_24.svg', alt='Diagrama de círculos de calidad con cinco características: mejora continua del producto, integrantes de la misma área, participación voluntaria, reuniones programadas y equipos de 3 a 15 personas.')
    ...
    .bg3.p-4.mb-5
      .row.justify-content-center
        .col-lg-9
          ...
          figure
            img(src='@/assets/curso/temas/tema1/img_30.svg', alt='Ilustración de una cabeza con un cerebro y engranajes, rodeada de herramientas de calidad y mejora de procesos como trabajo en equipo, liderazgo, control estadístico, Six Sigma y análisis de fallas.')
    ...
    .row.mb-5(data-aos="fade")
      .col-lg-9.mx-auto
        ...
        figure
          img(src='@/assets/curso/temas/tema1/img_32.svg', alt='Diagrama comparativo entre costo de calidad y costo de no calidad, que muestra actividades de prevención y evaluación, así como fallos internos y externos con ejemplos asociados.')
    ...
    .row.justify-content-center.mb-5(data-aos="fade")
      .col-lg-12
        ...
        figure
          img(src="@/assets/curso/temas/tema1/img_105.svg", alt='Ejemplos visuales de defectos en costuras textiles, como falta de tensión, costuras recogidas, saltos de puntada, hilos sueltos, remates defectuosos, roturas y problemas de simetría.')
